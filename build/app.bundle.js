 ...
 */var toStringOrTrustedType=toString;if(enableTrustedTypesIntegration&&typeof trustedTypes!=='undefined'){toStringOrTrustedType=function toStringOrTrustedType(value){if((typeof value==='undefined'?'undefined':_typeof(value))==='object'&&(trustedTypes.isHTML(value)||trustedTypes.isScript(value)||trustedTypes.isScriptURL(value)||/* TrustedURLs are deprecated and will be removed soon: https://github.com/WICG/trusted-types/pull/204 */trustedTypes.isURL&&trustedTypes.isURL(value))){// Pass Trusted Types through.
...
var _SideBar = __webpack_require__(/*! ./containers/Sidebar/SideBar */ "./src/containers/Sidebar/SideBar.js");

var _SideBar2 = _interopRequireDefault(_SideBar);

var _Main = __webpack_require__(/*! ./containers/Main/Main */ "./src/containers/Main/Main.js");
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        key: 'handleChild',
        value: function handleChild(child) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_SideBar2.default, { handleChild: this.handleChild }),
                _react2.default.createElement(_Main2.default, { activeChild: this.state.activeChild })
            );
        }
    }]);
...
/***/ "./src/components/Appearance/Appearance.js":
/*!*************************************************!*\
  !*** ./src/components/Appearance/Appearance.js ***!
  \*************************************************/
/*! no static exports found */
...
var _PictureFrame = __webpack_require__(/*! ../PictureFrame/PictureFrame */ "./src/components/PictureFrame/PictureFrame.js");
...
var Appearance = function (_React$Component) {
		...
		value: function render() {
			return (
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('img', { className: 'main-pictures', src: './src/static/img/baby-llama.jpg' }),
					_react2.default.createElement(
						'h3',
						{ className: 'small-head' },
						'Big Llama'
					),
					_react2.default.createElement('img', { className: 'main-pictures', src: './src/static/img/big-llama.jpg' }),
					_react2.default.createElement(
						'h3',
						{ className: 'small-head' },
						'More pictures'
					...
					_react2.default.createElement(
						'ul',
						{ className: 'picture-frames' },
						_react2.default.createElement(_PictureFrame2.default, { img_src: './src/static/img/llama-1.jpg', text: 'having lunch' }),
						_react2.default.createElement(_PictureFrame2.default, { img_src: './src/static/img/llama-2.jpg', text: 'relaxing' }),
						_react2.default.createElement(_PictureFrame2.default, { img_src: './src/static/img/llama-3.jpg', text: 'posing' }),
						_react2.default.createElement(_PictureFrame2.default, { img_src: './src/static/img/llama-4.jpg', text: 'having fun' }),
						_react2.default.createElement(_PictureFrame2.default, { img_src: './src/static/img/llama-5.jpg', text: 'annoyed' })
					)
				)
...
/***/ "./src/components/FunFacts/FunFacts.js":
/*!*********************************************!*\
  !*** ./src/components/FunFacts/FunFacts.js ***!
  \*********************************************/
/*! no static exports found */
...
var FunFacts = function (_React$Component) {
	_inherits(FunFacts, _React$Component);

	function FunFacts(props) {
		_classCallCheck(this, FunFacts);

		return _possibleConstructorReturn(this, (FunFacts.__proto__ || Object.getPrototypeOf(FunFacts)).call(this, props));
	}
...
var Introduction = function (_React$Component) {
	...
	function Introduction(props) {
		...
		return _possibleConstructorReturn(this, (Introduction.__proto__ || Object.getPrototypeOf(Introduction)).call(this, props));
	}
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								{ className: 'para' },
								'These sturdy creatures are domestic animals used by the peoples of the Andes Mountains. (Their wild relatives are guanacos and vicu\xF1as). Native peoples have used llamas as pack animals for centuries. Typically, they are saddled with loads of 50 to 75 pounds. Under such weight they can cover up to 20 miles in a single day. Pack trains of llamas, which can include several hundred animals, move large amounts of goods over even the very rough terrain of the Andes.',
...
/***/ "./src/components/PictureFrame/PictureFrame.js":
/*!*****************************************************!*\
  !*** ./src/components/PictureFrame/PictureFrame.js ***!
  \*****************************************************/
/*! no static exports found */
...
var PictureFrame = function (_React$Component) {
	_inherits(PictureFrame, _React$Component);

	function PictureFrame(props) {
		_classCallCheck(this, PictureFrame);

		return _possibleConstructorReturn(this, (PictureFrame.__proto__ || Object.getPrototypeOf(PictureFrame)).call(this, props));
	}
		...
		value: function render() {
			return (
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('div', { style: { backgroundImage: 'url(' + this.props.img_src + ')' } }),
					_react2.default.createElement(
						'p',
						{ className: 'para' },
						this.props.text
...
var Slideshow = function (_React$Component) {
	...
	function Slideshow(props) {
		...
		_this.state = {
			facts: ["Llamas are hardy and well suited to harsh environments. They are quite sure-footed, easily navigating rocky terrain at high altitudes.", "Llamas are smart and easy to train.", "Llamas have been used as guard animals for livestock like sheep or even alpacas in North America since the '80s. They require almost no training to be an effective guard.", "Llamas don't bite. They spit when they're agitated, but that's mostly at each other. Llamas also kick and neck wrestle each other when agitated.", "Llamas are vegetarians and have very efficient digestive systems.", "A llama's stomach has three compartments. They are called the rumen, omasum, and abomasum. A cow's stomach has four compartments. Like cows, llamas must regurgitate and re-chew their food to digest it completely.", "Llama poop has almost no odor. Llama farmers refer to llama manure as 'llama beans.' It makes for a great, eco-friendly fertilizer. Historically, the Incas in Peru burned dried llama poop for fuel.", "Llamas live to be about 20 years old. Though some only live for 15 years and others live to be 30 years old."],
			currentIndex: 0,
			translateValue: 0
		};
	...
	_createClass(Slideshow, [{
		...
		value: function render() {
			...
			var href = "https://twitter.com/intent/tweet?text=" + this.state.facts[this.state.currentIndex];
			return _react2.default.createElement(
				'div',
				{ className: 'slideshow' },
				_react2.default.createElement(
					...
					this.state.facts.map(function (text, i) {
						return _react2.default.createElement(Slide, { key: i, text: text });
					})
				),
				_react2.default.createElement(
					'a',
					{ title: 'tweet this fact', href: href, target: '_blank' },
					_react2.default.createElement('img', { src: './src/static/icons/twitter.svg' })
				),
...
var LeftArrow = function LeftArrow(props) {
	return _react2.default.createElement(
		...
		_react2.default.createElement('img', { className: 'back-arrow', src: './src/static/icons/back.svg' })
	);
};
...
var RightArrow = function RightArrow(props) {
	return _react2.default.createElement(
		...
		_react2.default.createElement('img', { className: 'forward-arrow', src: './src/static/icons/forward.svg' })
	);
};
...
var _FunFacts = __webpack_require__(/*! ../../components/FunFacts/FunFacts */ "./src/components/FunFacts/FunFacts.js");

var _FunFacts2 = _interopRequireDefault(_FunFacts);

var _Appearance = __webpack_require__(/*! ../../components/Appearance/Appearance */ "./src/components/Appearance/Appearance.js");

var _Appearance2 = _interopRequireDefault(_Appearance);

var _Introduction = __webpack_require__(/*! ../../components/Introduction/Introduction */ "./src/components/Introduction/Introduction.js");

var _Introduction2 = _interopRequireDefault(_Introduction);

var _Game = __webpack_require__(/*! ../../components/Game/Game */ "./src/components/Game/Game.js");
...
var Main = function (_React$Component) {
	...
	_createClass(Main, [{
		...
		value: function render() {
			...
			var child = void 0;
			var ac = this.props.activeChild;

			// if active child is pressed display it
			if (ac === 'Fun Facts') child = _react2.default.createElement(_FunFacts2.default, null);else if (ac === 'Appearance') child = _react2.default.createElement(_Appearance2.default, null);else if (ac === 'Introduction') child = _react2.default.createElement(_Introduction2.default, null);else if (ac === 'Game') child = _react2.default.createElement(_Game2.default, null);else child = _react2.default.createElement(
				'div',
				null,
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'header',
					{ className: 'hamburger' },
					_react2.default.createElement('img', { onClick: this.toggleMenu, src: './src/static/icons/hamburger.svg' }),
					_react2.default.createElement(
						'h4',
				...
				_react2.default.createElement(
					'div',
					{ className: 'nav-bar ' + (this.state.phoneNav ? 'nav-active' : 'nav-not-active') },
					_react2.default.createElement('img', { className: 'close-hamburger', onClick: this.toggleMenu, src: './src/static/icons/close.svg' }),
					_react2.default.createElement(
						'header',
						null,
						_react2.default.createElement(
					...
					_react2.default.createElement('img', { src: './src/static/img/llama-logo.png', className: 'llama-img' })
				)
			);
		}
	}]);
