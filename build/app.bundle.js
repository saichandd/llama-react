...
var _Desktop = __webpack_require__(/*! ./containers/Desktop/Desktop */ "./src/containers/Desktop/Desktop.js");

var _Desktop2 = _interopRequireDefault(_Desktop);

var _Dock = __webpack_require__(/*! ./containers/Dock/Dock */ "./src/containers/Dock/Dock.js");
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        // ac changes on click in left sidebar
        var _this = _possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).call(this, props));

        _this.handleChild = function (child) {
            _this.setState({ ac: child });
        };

        _this.toggleWall = function () {
            _this.setState({ wall: !_this.state.wall });
        };

        _this.onMouseDown = function () {
            _this.setState({ pullmore: true });
        };

        _this.onMouseUp = function () {
            _this.setState({ pullmore: false });
        };
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Desktop2.default, { handleChild: this.handleChild, ac: this.state.ac, wall: this.state.wall }),
                !this.state.wall && _react2.default.createElement(_Dock2.default, { handleChild: this.handleChild, ac: this.state.ac }),
                _react2.default.createElement(
                    'div',
                    { className: 'wall', onClick: this.toggleWall, onMouseDown: this.onMouseDown, onMouseUp: this.onMouseUp },
                    _react2.default.createElement('div', { className: "wall-pull " + (this.state.pullmore ? 'wall-pull-more' : '') }),
                    _react2.default.createElement(
                        'p',
                        null,
                        this.state.wall ? 'BACK' : 'MORE'
                    )
                )
            );
        }
...
var Education = function (_React$Component) {
	...
	function Education(props) {
		...
		_this.state = {
			content: {
				'Undergraduate': {
					'university': 'Indian Institude of Technology Hyderabad',
					'degree': 'Batcher of Technology in Engineering with Computer Science coursework',
					'coursework': 'Data Structures - I, Data Structures - II, Programming in C/C++, Probability, Statistics,\
								Calculus - I, Calculus - II, Vector Calculus, Linear Algebra, Differential Equations, Complex Variables. Audited Algorithms and Operating Systems'
				},
				'Graduate': {
					'university': 'Stony Brook University',
					'degree': 'Master of Science in Computer Science',
					'coursework': 'Analysis of Algorithms, Theory of Database Systems, Systems Fundamentals II, Programming Languages, Visualization, Computer Vision, Intro to Data Science, Theory of Computation'
				}
			}
		};
		return _this;
	...
	_createClass(Education, [{
		...
		value: function render() {
			...
			var tab_data = this.state.content[this.props.active_tab];
			return (
				// Logo component
				_react2.default.createElement(
					'div',
		...
		_this.state = {
			content: {
                'Frio': {
					...
					'time_place': 'Jun 2020 - Aug 2020 | Brooklyn, New York',
					'work': ['Lead the end-to-end design and development of the Android app with the team for the IoT application in Java.','Implemented user authentication and managed the user pools in AWS Cognito. Worked on REST APIs tocommunicate user data with cloud.', 'Wrote unit tests and debugged critical application issues such as crashes and memory leaks.']
				},
				'Stumagz': {
					'job': 'Software Developer Intern',
					'time_place': 'April 2018 - Jul 2018 | Hyderabad',
					'work': ['Designed and implemented the end to end chat module for the company’s mobile app in React Native, worked with fellow interns in implementing the payment and stories modules for the same application.', 'Increased the performance of the app by changing the navigation for the entire app by using native modules on a javascript bridge, contrary to the previous implementation which used an all javascript implementation.']
				},
				'Topcoder': {
					'job': 'Software Development Competitor',
					'time_place': '2018 - 2019',
					'work': ['Competed in several software development challenges while in undergrad. Collaborated with designers and other developers to bring out a great product by making the right decisions', 'Topcoder Open 2018 UI Prototype Finalist. Won $3850 in prizes with Win rate of 28.5% competing on Topcoder during undergraduate.'],
					'link_to_profile': 'topcoder.com/radioactivCoder'
				}
			}
		};
		return _this;
		...
		value: function render() {
			...
			return (
				...
				_react2.default.createElement(
					'div',
					{ className: 'education-container' },
					_react2.default.createElement('img', { className: 'work-logo', src: './src/static/img/' + this.props.active_tab.toLowerCase() + '.png' }),
					_react2.default.createElement(
						'h2',
						{ className: 'child-h2' },
						tab_data['job']
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'ul',
							null,
							tab_data['work'].map(function (child, i) {
								return _react2.default.createElement(
									'li',
									{ key: i },
									child
					...
					tab_data[ true && _react2.default.createElement(
						'a',
						{ href: tab_data['link_to_profile'] },
						'link to profile'
					)]
				)
			);
...
var Projects = function (_React$Component) {
	...
	_createClass(Projects, [{
		key: 'render',
		value: function render() {
			var tab_data = Projects.content[this.props.active_tab];
			return (
				// Logo component
				_react2.default.createElement(
					'div',
					{ className: 'projects-container' },
					tab_data.map(function (child, i) {
						return _react2.default.createElement(
							'div',
							{ key: i },
							_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{ style: child['NDA'] && { display: 'none' } },
									_react2.default.createElement(
										'a',
										{ target: '_blank', href: child['github'] },
										_react2.default.createElement('img', { src: './src/static/icons/github.png' })
									)
								),
								_react2.default.createElement(
									'div',
									null,
									child['tech'].map(function (e, j) {
										return _react2.default.createElement(
											'div',
											{ key: j },
											e
...
Projects.content = {
	'Web & Mobile': [{
		...
		'description': 'Implemented a data analytics tool which can be used to get insights about the production data of a company specific to a location. Charts are rendered on map which disintegrate into more detail as zoomed in.',
		'github': 'NDA Protected',
		'NDA': true
	}, {
		'title': 'ReactNative UI Toolkit',
		'tech': ['ReactNative', 'React', 'Javascript', 'HTML', 'CSS'],
		'description': 'Implemented a data analytics tool which can be used to get insights about the production data of a company specific to a location. Charts are rendered on map which disintegrate into more detail as zoomed in.',
		'github': 'NDA Protected',
		'NDA': true
		...
		'tech': ['React', 'Redux', 'Javascript', 'HTML', 'CSS'],
		'description': 'Implemented an interactive UI of pipelines to get clearer insights about all the end-to- end business process going on at a client’s company.',
		'NDA': true
	...
	'Systems': [{
		...
		'tech': ['C', 'GDB', 'Valgrind'],
		'description': 'Designed and implemented a multithreaded exchange server in C for e-trading.\
					Implemented trader, exchange and client registry modules other than achieving concurrency over iterative load handling.',
		'github': 'https://github.com/saichandd/Bourse-Server'
	}, {
		'title': 'Job Scheduler',
		'tech': ['C', 'GDB', 'Valgrind'],
		'description': 'A job spooler program for UNIX, that accepts user requests to spool tasks for execution, cancel, pause and resume, show the status of jobs. The programme also expunges terminated jobs in the background to free resources for new tasks.',
		'github': 'https://github.com/saichandd/Job-Scheduler'
	}, {
		'title': 'Dyamic Memory Allocator',
		'tech': ['C', 'GDB', 'Valgrind'],
		'description': 'Designed and implemented a multithreaded exchange server in C for e-trading.\
					Implemented trader, exchange and client registry modules other than achieving concurrency over iterative load handling.',
		'github': 'https://github.com/saichandd/Dynamic-Memory-Allocator'
	}, {
		'title': 'File Archiver',
		'tech': ['C', 'GDB'],
		'description': 'Implemented a command line utility like cpio for UNIX serialize a tree of files and directories to a sequence of bytes and to deserialize such a sequence of bytes to re-create the original tree. Used only stdio library for the entire project.\
				 The utility can be used by command line with flags to ask for a particular process, also has optional flags for help and to choose the directory to deserialize the byte data.',
		'github': 'https://github.com/saichandd/cpio'
	}, {
		'title': 'Rolodex',
		'tech': ['C', 'K&R C'],
		'description': 'Designed and implemented a multithreaded exchange server in C for e-trading.\
					Implemented trader, exchange and client registry modules other than achieving concurrency over iterative load handling.',
		'github': 'https://github.com/saichandd/rolodex'
	}],
	'Machine Learning': [{
		'title': 'Estimating 3D pose with 2D pose',
		'tech': ['Scikit-learn', 'PyTorch', 'NumPy', 'pandas', 'matplotlib'],
		'description': 'Implemented this state-of-the art paper on estimating the 3D pose of a person from 2D bone \
				structure using convolutional neural networks with residual connections on the human 3.6M dataset, the largest publicly available 3d pose estimation benchmark.',
		'github': 'https://github.com/saichandd/Estimating-3D-pose-from-2D-pose'
	}, {
	...
	'Other': [{
		'title': 'Stony Brook Markup Language',
		'tech': ['Python', 'Ply'],
		'description': 'Implemented SBML language for compiling and executing conditionals, loops and conditionals as per the specifications using parser generator PLY (Python Lex and Yacc)',
		'github': 'https://github.com/saichandd/sbml'
	}]
};
...
/***/ "./src/containers/ApplicationsFinder/ApplicationsFinder.js":
/*!*****************************************************************!*\
  !*** ./src/containers/ApplicationsFinder/ApplicationsFinder.js ***!
  \*****************************************************************/
/*! no static exports found */
...
var ApplicationsFinder = function (_React$Component) {
    _inherits(ApplicationsFinder, _React$Component);

    function ApplicationsFinder() {
        var _ref;

        var _temp, _this, _ret;

        _classCallCheck(this, ApplicationsFinder);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ApplicationsFinder.__proto__ || Object.getPrototypeOf(ApplicationsFinder)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            game: null
    ...
    _createClass(ApplicationsFinder, [{
        key: 'handleClick',
        value: function handleClick(app) {
            if (app == 'Llama Survive') {
                this.setState({ game: _react2.default.createElement(LlamaGame, null) });
            }
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return (
                ...
                _react2.default.createElement(
                    ...
                    this.state.game != null ? this.state.game :

                    // map to render all in left side bar
                    ApplicationsFinder.apps.map(function (app, i) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'game' },
                            _react2.default.createElement('img', { key: i, id: i, onClick: function onClick(e) {
                                    return _this2.handleClick(app, e);
                                },
                                title: app, src: './src/static/img/' + app.toLowerCase() + '.png' }),
                            _react2.default.createElement('p', { className: 'para' })
                        );
                    })
                )
    ...
    return ApplicationsFinder;
}(_react2.default.Component);

ApplicationsFinder.apps = [{
    'Llama Survive': {
        'description': 'eat the Apples'
    }
}];
exports.default = ApplicationsFinder;

/***/ }),

/***/ "./src/containers/Desktop/Desktop.js":
/*!*******************************************!*\
  !*** ./src/containers/Desktop/Desktop.js ***!
  \*******************************************/
/*! no static exports found */
...
var _ApplicationsFinder = __webpack_require__(/*! ../ApplicationsFinder/ApplicationsFinder */ "./src/containers/ApplicationsFinder/ApplicationsFinder.js");

var _ApplicationsFinder2 = _interopRequireDefault(_ApplicationsFinder);

var _Finder = __webpack_require__(/*! ../Finder/Finder */ "./src/containers/Finder/Finder.js");

var _Finder2 = _interopRequireDefault(_Finder);

var _Intro = __webpack_require__(/*! ./Intro/Intro */ "./src/containers/Desktop/Intro/Intro.js");
...
var Desktop = function (_React$Component) {
	...
	function Desktop() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Desktop.__proto__ || Object.getPrototypeOf(Desktop)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			...
			offset: [0, 0],
			fullscreen: false
		}, _this.myWindow = _react2.default.createRef(), _this.mouseDown = function (e) {
			_this.setState({
				mouseDown: true,
				offset: [_this.myWindow.current.offsetLeft - e.clientX, _this.myWindow.current.offsetTop - e.clientY]
			});
			...
			if (_this.state.mouseDown) {
				...
				_this.myWindow.current.style.left = mousePosition.x + _this.state.offset[0] + 'px';
				_this.myWindow.current.style.top = mousePosition.y + _this.state.offset[1] + 'px';
			}
		}, _this.closeFinder = function () {
			_this.props.handleChild(null);
	...
	_createClass(Desktop, [{
		...
		value: function render() {
			...
			if (ac === 'Education' || ac === 'Experience' || ac === 'Projects') child = _react2.default.createElement(_Finder2.default, { ac: this.props.ac });else if (ac === 'Games') child = _react2.default.createElement(_ApplicationsFinder2.default, { ac: this.props.ac });

			return (
				// right side content
				this.props.wall ? _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'p',
						null,
						'Hi again, I love working on great products working with a great group of people. Feel free to contact me if you have anything in mind or if just wanna tell me a joke.',
						...
						', majoring in Computer Science. I\'m very good with fundamentals of computer science, data structures and algorithms.',
						_react2.default.createElement('br', null),
						'I\'m looking for an internships for summer/fall 2020, let me know at saichanddduppala[at]gmail.com you\'d like to give me an interview.',
						_react2.default.createElement('br', null),
						_react2.default.createElement('br', null),
					...
					_react2.default.createElement(
						'div',
						{ className: 'contact' },
						_react2.default.createElement('a', { target: '_blank', rel: 'noopener noreferrer', href: 'https://www.linkedin.com/in/sai-chand-duppala-71bb63117' }),
						_react2.default.createElement('a', { target: '_blank', rel: 'noopener noreferrer', href: 'https://www.github.com/saichandd' })
					),
					_react2.default.createElement(
						'footer',
						null,
					...
					child ? _react2.default.createElement(
						'div',
						{ className: 'window-container ' + (this.state.fullscreen ? 'window-fullscreen' : ''),
							ref: this.myWindow,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'close-window-button', onClick: this.closeFinder },
								_react2.default.createElement('img', { src: './src/static/icons/close.svg' })
							),
							_react2.default.createElement(
								'div',
								{ className: 'fullscreen-button', onClick: this.fullScreen },
								_react2.default.createElement('img', { src: './src/static/icons/fullscreen.svg' })
							)
						),
						child
					) : null
...
/***/ "./src/containers/Desktop/Intro/Intro.js":
/*!***********************************************!*\
  !*** ./src/containers/Desktop/Intro/Intro.js ***!
  \***********************************************/
/*! no static exports found */
...
var Intro = function (_React$Component) {
	...
	function Intro() {
		...
		return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref = Intro.__proto__ || Object.getPrototypeOf(Intro)).call.apply(_ref, [this].concat(args))), _this2), _this2.state = {
			hover: [[false, false, false, false, false, false], [false], [false, false], [false, false, false, false, false, false, false, false]],
			visible: [[false, false, false, false, false, false], [false], [false, false], [false, false, false, false, false, false, false, false]]
		}, _this2.rubberBand = function (j, i) {
			var hover = _this2.state.hover;
			hover[j][i] = true;
			_this2.setState({
				hover: hover
			});
	...
	_createClass(Intro, [{
		...
		value: function componentDidMount() {
			var x = 0;
			for (var i = 0; i < Intro.greeting.length; i++) {
				for (var j = 0; j < Intro.greeting[i].length; j++) {
					doSetTimeOut(x, i, j);
					x++;
				}
			}
			...
			var _this = this;
			function doSetTimeOut(x, i, j) {
				setTimeout(function () {
					var hover = _this.state.hover;
					var visible = _this.state.visible;
					// console.log(hover)
					hover[i][j] = true, visible[i][j] = true;
					_this.setState({
						hover: hover,
						visible: visible
					});
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'header',
					null,
					Intro.greeting[0].map(function (child, i) {
						return _react2.default.createElement(
							'span',
							{ key: i,
								onMouseOver: function onMouseOver() {
									return _this3.rubberBand(0, i);
								},
								className: (_this3.state.hover[0][i] ? 'animate-rubber' : '') + ' ' + (_this3.state.visible[0][i] ? 'visible' : '') + (child === '.' ? ' orange' : '') },
							child
						);
					}),
					_react2.default.createElement('br', null),
					Intro.greeting[1].map(function (child, i) {
						return _react2.default.createElement(
							'span',
							{ key: i,
								onMouseOver: function onMouseOver() {
									return _this3.rubberBand(1, i);
								},
								className: (_this3.state.hover[1][i] ? 'animate-rubber' : '') + ' ' + (_this3.state.visible[1][i] ? 'visible' : '') },
							child
						);
					}),
					'\xA0',
					Intro.greeting[2].map(function (child, i) {
						return _react2.default.createElement(
							'span',
							{ key: i,
								onMouseOver: function onMouseOver() {
									return _this3.rubberBand(2, i);
								},
								className: (_this3.state.hover[2][i] ? 'animate-rubber' : '') + ' ' + (_this3.state.visible[2][i] ? 'visible' : '') },
							child
						);
					}),
					'\xA0',
					Intro.greeting[3].map(function (child, i) {
						return _react2.default.createElement(
							'span',
							{ key: i,
								onMouseOver: function onMouseOver() {
									return _this3.rubberBand(3, i);
								},
								className: (_this3.state.hover[3][i] ? 'animate-rubber' : '') + ' ' + (_this3.state.visible[3][i] ? 'visible' : '') },
							child
						);
					})
				),
				_react2.default.createElement(
					...
					'I\'m a Developer.',
					_react2.default.createElement('br', null),
					'Click the buttons below to know more about me.'
				)
			);
		}
	}]);
...
Intro.greeting = [['H', 'e', 'l', 'l', 'o', '.'], ['I'], ['a', 'm'], ['S', 'a', 'i', 'C', 'h', 'a', 'n', 'd']];
exports.default = Intro;

/***/ }),

/***/ "./src/containers/Dock/Dock.js":
/*!*************************************!*\
  !*** ./src/containers/Dock/Dock.js ***!
  \*************************************/
/*! no static exports found */
...
var SideBar = function (_React$Component) {
	...
	function SideBar(props) {
		...
		_this.state = {
			children: ['Education', 'Experience', 'Projects'],
	...
	_createClass(SideBar, [{
		...
		key: 'handleClick',
		value: function handleClick(child) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'dock ' + (this.state.phoneNav ? 'dock-active' : 'dock-not-active') },
				...
				children.map(function (child, i) {
					return _react2.default.createElement(
						...
						{ key: i, onClick: function onClick(e) {
								return _this2.handleClick(child, e);
							} },
						_react2.default.createElement('img', { className: (_this2.props.ac === child ? 'active ' : '') + child.toLowerCase(),
							src: './src/static/icons/' + (child.toLowerCase() + (_this2.props.ac === child ? '-active' : '')) + '.svg' }),
						_react2.default.createElement(
							'p',
							{ className: _this2.props.ac == child ? 'active' : '' },
							child
						)
					);
				})
...
/***/ "./src/containers/Finder/Finder.js":
/*!*****************************************!*\
  !*** ./src/containers/Finder/Finder.js ***!
  \*****************************************/
/*! no static exports found */
...
var _SideBar = __webpack_require__(/*! ./Sidebar/SideBar */ "./src/containers/Finder/Sidebar/SideBar.js");

var _SideBar2 = _interopRequireDefault(_SideBar);

var _Main = __webpack_require__(/*! ./Main/Main */ "./src/containers/Finder/Main/Main.js");
...
var Finder = function (_React$Component) {
    ...
    function Finder() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Finder.__proto__ || Object.getPrototypeOf(Finder)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            active_tab: Finder.groups[_this.props.ac][0],
            tabs: Finder.groups[_this.props.ac]
            // on props change
        }, _this.handleChild = function (active_tab) {
            _this.setState({ active_tab: active_tab });
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(Finder, [{
        ...
        value: function render() {
            return (
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_SideBar2.default, { handleChild: this.handleChild, group: this.props.ac, tabs: this.state.tabs }),
                    _react2.default.createElement(_Main2.default, { group: this.props.ac, active_tab: this.state.active_tab })
                )
        ...
        value: function getDerivedStateFromProps(nextprops, prevstate) {
            if (Finder.groups[nextprops.ac] != prevstate.tabs) {
                return {
                    active_tab: Finder.groups[nextprops.ac][0],
                    tabs: Finder.groups[nextprops.ac]
                };
            } else {
                return null;
            }
...
Finder.groups = {
    ...
    'Experience': ['Frio','Stumagz', 'Topcoder'],
    'Projects': ['Web & Mobile', 'Systems', 'Machine Learning', 'Other']
};
exports.default = Finder;

/***/ }),

/***/ "./src/containers/Finder/Main/Main.js":
/*!********************************************!*\
  !*** ./src/containers/Finder/Main/Main.js ***!
  \********************************************/
/*! no static exports found */
...
var _Education = __webpack_require__(/*! ../../../components/Education/Education */ "./src/components/Education/Education.js");
...
var Main = function (_React$Component) {
	...
	_createClass(Main, [{
		...
		value: function render() {
			...
			var child = void 0;
			var at = this.props.active_tab;
			var ac = this.props.group;

			// if active child is pressed display it
			if (ac === 'Education') child = _react2.default.createElement(_Education2.default, { active_tab: at });else if (ac === 'Experience') child = _react2.default.createElement(_Experience2.default, { active_tab: at });else if (ac === 'Projects') child = _react2.default.createElement(_Projects2.default, { active_tab: at });
			// else if(ac === 'Applications')
			// 	child = <Applications/>
			// else if(ac === 'Game')
			// 	child = <Game/>
			else child = _react2.default.createElement(
					'div',
					null,
...
/***/ "./src/containers/Finder/Sidebar/SideBar.js":
/*!**************************************************!*\
  !*** ./src/containers/Finder/Sidebar/SideBar.js ***!
  \**************************************************/
/*! no static exports found */
...
var SideBar = function (_React$Component) {
	...
	function SideBar() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SideBar.__proto__ || Object.getPrototypeOf(SideBar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			children: _this.props.tabs,
			// current active component is activeChild
			activeChild: _this.props.tabs[0]
			// phoneNav: false
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						children.map(function (child, i) {
							return _react2.default.createElement(
								'li',
								{ className: _this2.state.activeChild === child ? 'active' : '', key: i, id: i, onClick: function onClick(e) {
										return _this2.handleClick(child, e);
									} },
								child
							);
